...
import {
  ...
  where
} from "./chunk-ZGKSQIZ4.js";
import "./chunk-F2HDKAQN.js";
import {
  FirebaseApp,
  VERSION as VERSION2,
...
import {
  ...
  ɵɵdefineNgModule,
  ɵɵinject
} from "./chunk-BWHHHPNE.js";
import {
  merge
} from "./chunk-P27OXTXE.js";
...
var AngularFireAuth = class _AngularFireAuth {
  ...
  constructor(options, name4, platformId, zone, schedulers, useEmulator, settings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
    ...
    const auth = of(void 0).pipe(observeOn(schedulers.outsideAngular), switchMap(() => zone.runOutsideAngular(() => import("./index.esm-6NIBSD5R.js"))), map(() => ɵfirebaseAppFactory(options, zone, name4)), map((app) => ɵauthFactory(app, zone, useEmulator, tenantId, languageCode, useDeviceLanguage, settings, persistence)), shareReplay({
      bufferSize: 1,
      refCount: false
    }));
...
var name3 = "@firebase/firestore-compat";
var version3 = "0.3.38";
...
var Firestore = class {
  ...
  namedQuery(name4) {
    return namedQuery(this._delegate, name4).then((expQuery) => {
      if (!expQuery) {
        return null;
      }
      return new Query(
...
var AngularFirestore = class _AngularFirestore {
   ...
   */
  constructor(options, name4, shouldEnablePersistence, settings, platformId, zone, schedulers, persistenceSettings, _useEmulator, auth, useAuthEmulator, authSettings, tenantId, languageCode, useDeviceLanguage, persistence, _appCheckInstances) {
